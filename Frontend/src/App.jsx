...
=======
    <a href="/vouchers" style={{ display: 'inline-block', padding: '10px 24px', background: '#3b82f6', color: '#fff', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold' }}>
      Go to Food Vouchers
>>>>>>> 69c5178f071b6781906c8d3cb8f78ae2f9202a0f
>>>>>>> fcbe8fe5505d71b220d036f08c478b350c0f86b1
=======
          ...
          <Route
            ...
            element={
              <ProtectedRoute allowedRoles={['property_owner']}>
                <OwnerDashboard />
=======
          {/* Developer 4 Active Routes */}
          <Route path="/" element={<FoodVouchers />} />
